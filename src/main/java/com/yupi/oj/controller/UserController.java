...
import com.yupi.oj.config.WxOpenConfig;
...
public class UserController {
    ...
    @GetMapping("/insertwxy")
    public String insertwxy(){
        int i =userMapper.insert_wxy();
        System.out.println("11111111111111111111:查出来的数是："+i);
        return "OK!!!!!!!!!";
    }
    @GetMapping("/updatewxy")
    public String updatewxy(){
        int i =userMapper.update_wxy();
        System.out.println("11111111111111111111:查出来的数是："+i);
        return "OK!!!!!!!!!";
    }
}
